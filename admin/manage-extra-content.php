...
if(isset($_POST['Dectivate']) && $bb!='')
{
		foreach($bb as $act)
		{
		 mysqli_query($conn,"update tbl_extra_content set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"update tbl_extra_content set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"delete from tbl_extra_content where id='$act'");
		}
}
		
		$mqry="select * from tbl_extra_content order by id desc";
                       ...
                       <form name="myform" method="post" action=""> 
						...
						<div class="alert alert-secondary fade show">
							...
							<div class="btn-group btn-group-justified">
                              <a href="add-extra-content.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New Extra Content</a>
							...
							<table id="data-table-responsive" class="table table-striped table-bordered">
                                ...
                                <?php $count=1; $fetch=mysqli_query($conn,$mqry);
									...
									<tr class="odd gradeX">
                                      ...
                                      <td><a href="edit-extra-content.php?bid=<?php echo $web['id'];?>" class='label label-sm label-primary' data-toggle="tooltip" title="Edit project" ><i class="fa fa-edit"></i> EDIT</a></td>
                                      <td><a href="delete/extra-content.php?bid=<?php echo $web['id'];?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" class='label label-sm label-danger' data-toggle="tooltip" title="Delete project" ><i class="fa fa-trash"></i> DELETE</a></td>
...
function updateId(id)
{
    ...
    xmlhttp.open("GET", "status/extra-content.php?id=" +id, true);
    xmlhttp.send();
}
</script>
