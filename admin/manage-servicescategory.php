...
if(isset($_POST['submit']))
{
  ...
  $query=mysqli_query($conn,"INSERT INTO `tbl_servicescategory`(`name`,`image`,`sort`,`status`) VALUES ('$name','$bimage','$sort','$status')");
	if($query==true)
	{
...
if(isset($_POST['update']))
{
  ...
  {
    $ig=mysqli_query($conn,"SELECT * FROM `tbl_servicescategory` WHERE `id`='$b'"); 
	$brec=mysqli_fetch_array($ig);
    $bimage=$brec['image'];
  }
  $query=mysqli_query($conn,"UPDATE `tbl_servicescategory` SET `name`='$name',`image`='$bimage', `sort`='$sort', `status`='$status' WHERE `id`='$b'");
  if($query==true)
  {
	...
	<?php require("includes/left.php"); ?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Manage Services Category </a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Services Category </h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Add Services Category</h4>
						</div>
						<!-- end panel-heading -->
                ...
                <div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">View Services Category</h4>
						</div>
						<!-- end panel-heading -->
						<div class="panel-body">
						<!-- begin panel-body -->
						<table  class="table table-striped table-bordered">
								...
								<tbody>
                                <?php $trc=mysqli_query($conn,"SELECT * FROM `tbl_servicescategory` ORDER BY `id`"); 
                                $i=1;
						       ...
						       ?> 
									<tr class="odd gradeX">
										...
										<td width="1%" class="with-img"><img src="../uploads/services/<?= $mrc['image'];?>" class="img-rounded height-60" /></td>
                                        ...
                                        <div class="switcher">
                                         ...
                                         <td>
                                          <a href="#modal-editservices<?php echo $mrc['id'];?>" class="label label-sm label-primary" title="Edit" style="text-decoration: none;" data-toggle="modal"><i class="fa fa-edit"></i> Edit</a>
                             <div class="modal fade" id="modal-editservices<?php echo $mrc['id'];?>" aria-hidden="true" style="display: none;">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title">Edit Services Category</h4>
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo $mrc['id'];?>">
                                                     <div class="form-group">
                                                      ...
                                                      <input type="text"  name="name"  value="<?php echo $mrc['name'];?>" class="form-control" id="bannerlink">
                                                        ...
                                                        <img src="../uploads/services/<?= $mrc['image']; ?>" width="100" height="40">
                                                        </div>
                                        ...
                                        <td>
                                          <a href="delete/servicescategory.php?cid=<?php echo $mrc['id'];?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }"  class="label label-sm label-danger" title="Delete" style="text-decoration: none;"><i class="fa fa-trash"></i> Delete</a>
                                        </td>
									</tr>
								<?php  $i++; } ?>
                                    <tfoot>
...
function updateId(id)
{
    ...
    xmlhttp.open("GET", "status/servicescategory.php?id=" +id, true);
    xmlhttp.send();
}
</script>
 <!--------------------------------------->  
