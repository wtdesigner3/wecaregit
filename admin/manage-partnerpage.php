...
$condata=mysqli_query($conn,"SELECT * FROM `tbl_partnerpage`");
...
// image one
 if(!empty($_FILES["aimage"]["name"])) { 
  ...
  move_uploaded_file($_FILES['aimage']['tmp_name'],"../uploads/client/".$aimage);
  }else{
 $aimage = $conrec['image'];
}

  $query=mysqli_query($conn,"UPDATE `tbl_partnerpage` SET `title`='$title',`image`='$aimage'");
if($query)
  {
...
<body>
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">Manage Partner</h1>
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
				<div class="col-lg-12">
		...
		<form role="form" method="POST"  enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="heading">Homepage Partner Title</label>
