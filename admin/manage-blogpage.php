...
$condata=mysqli_query($conn,"SELECT * FROM `tbl_blogpage`");
...
// image one
 if(!empty($_FILES["aimage"]["name"])) { 
  ...
  move_uploaded_file($_FILES['aimage']['tmp_name'],"../uploads/blog/".$aimage);
  }else{
 $aimage = $conrec['image'];
}

  $query=mysqli_query($conn,"UPDATE `tbl_blogpage` SET `title`='$title',`image`='$aimage'");
if($query)
  {
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Manage News Header</li>
			</ol>
			<!-- begin page-header -->
			<h1 class="page-header">Manage News Header</h1>
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage News Header</h4>
						</div>
						<!-- begin panel-body -->
		...
		<form role="form" method="POST"  enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="heading">Homepage News Header Title</label>
