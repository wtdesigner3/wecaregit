...
if (isset($_POST['submit'])) {
 ...
 $alt = mysqli_real_escape_string($conn, $_POST['alt']);
    ...
    $query = mysqli_query($conn, "INSERT INTO `tbl_extra`( `title_id`,`brand_id`,`image`,`alt`,`image2`,`alt2`,`title`,`subtitle`, `status`, `sort`) VALUES ('$heading','$category','$bimage','$alt','$bimage2','$alt2','$title','$subtitle','$status','$position')");
    if ($query == true) {
...
<body>
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">Add Extra</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Manage Extra<small>.</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-10 -->
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Extra</h4>
                    </div>
                    <!-- end panel-heading -->
                        ...
                        <form role="form" method="POST" enctype="multipart/form-data">
                            <div class="box-body">
                                  <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="heading" class="form-control" required>
                                                ...
                                                <?php
                                                $cttdata = mysqli_query($conn, "SELECT * FROM `tbl_extra_content` WHERE  `status`='1' ");
                                                while ($cttdatas = mysqli_fetch_array($cttdata)) {
                                                ?>
                                                    <option value="<?= $cttdatas['id']; ?>"><?= $cttdatas['title']; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-lg-6">
                                         <div class="form-group">
                                            <label for="exampleInputFile">Image (White)</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Image2 (Dark)</label>
