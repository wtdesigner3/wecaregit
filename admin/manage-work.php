...
if(isset($_POST['Dectivate']) && $bb!='')
{
		foreach($bb as $act)
		{
		 mysqli_query($conn,"update tbl_work set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"update tbl_work set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"delete from tbl_work where id='$act'");
		}
}
		
		$mqry="select * from tbl_work order by id desc";
	...
	<?php require("includes/left.php"); ?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Managed work</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage work</h4>
						</div>
						<!-- end panel-heading -->
                       <form name="myform" method="post" action=""> 
						...
						<div class="alert alert-secondary fade show">
							...
							<div class="btn-group btn-group-justified">
                              <a href="add-work.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New work</a>
							...
							<table id="data-table-responsive" class="table table-striped table-bordered">
                                ...
                                <?php $count=1; $fetch=mysqli_query($conn,$mqry);
									...
									<tr class="odd gradeX">
                                      ...
                                      <td width="1%" class="with-img"><img src="../uploads/work/<?php echo $web['image'];?>" class="img-rounded height-60" /></td>
                                      ...
                                      <td><a href="edit-work.php?bid=<?php echo $web['id'];?>" class='label label-sm label-primary' data-toggle="tooltip" title="Edit work" ><i class="fa fa-edit"></i> EDIT</a></td>
                                      <td><a href="delete/work.php?bid=<?php echo $web['id'];?>" class='label label-sm label-danger' data-toggle="tooltip" title="Delete work" ><i class="fa fa-trash"></i> DELETE</a></td>
...
function updateId(id)
{
    ...
    xmlhttp.open("GET", "status/work.php?id=" +id, true);
    xmlhttp.send();
}
</script>
