...
$b = $_REQUEST['eid'];
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_why_us` where `id`='$b'");
...
$query = mysqli_query($conn, "UPDATE `tbl_why_us` SET `brand_id`='$category',`title`='$title',`alt`='$alt',`alt2`='$alt2',`image`='$bimage',`image2`='$bimage2',`subtitle`='$subtitle',`status`='$status',`sort`='$position' WHERE `id`='$b'");

  if ($query == true) 
  {
    $_SESSION['success'] = "Updated Successfully";
    header("Refresh:2; url=manage-why-us.php");
  } 
  else 
  {
...
<body>
  ...
  <div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
      <li class="breadcrumb-item"><a href="javascript:;">Manage Why Us</a></li>
      <li class="breadcrumb-item"><a href="javascript:;">Edit Why Us</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Why Us</h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
      <!-- begin col-10 -->
      <div class="col-lg-12">
        ...
        <div class="panel panel-inverse">
          ...
          <div class="panel-heading">
            ...
            <h4 class="panel-title">Edit Why Us</h4>
          </div>
          <!-- end panel-heading -->
