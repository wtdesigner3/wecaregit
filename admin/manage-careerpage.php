...
$matatag = mysqli_real_escape_string($conn,$_POST['metatag']);
...
// image one
 if(!empty($_FILES["aimage"]["name"])) { 
  ...
  move_uploaded_file($_FILES['aimage']['tmp_name'],"../uploads/team/".$aimage);
  }else{
 $aimage = $conrec['image'];
}

  $query=mysqli_query($conn,"UPDATE `tbl_divisionpage` SET `title`='$title',`image`='$aimage', `metatag` = '$metatag', `metadesc` = '$metadesc', `metakeyword` = '$metakeyword', `head_detail` = '$head_detail'");
if($query)
  {
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Manage Careerpage</li>
			</ol>
			<!-- begin page-header -->
			<h1 class="page-header">Manage Careerpage</h1>
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage Careerpage</h4>
						</div>
						<!-- begin panel-body -->
		...
		<form role="form" method="POST"  enctype="multipart/form-data">
              <div class="box-body">
                ...
                <!-- <div class="form-group">
                  <label for="heading">Homepage Team Sub Title</label>
                ...
                <div style="border: 1px solid #242a30;padding: 10px;background: #fdfbef;"> 
                 <div class="form-group">
                  ...
                  <textarea name="metakeyword" id="keyword" placeholder="Meta Keyword" class="form-control" ></textarea>
                 </div>
