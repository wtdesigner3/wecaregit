...
$condata=mysqli_query($conn,"SELECT * FROM `tbl_brandpage`");
...
$condata=mysqli_query($conn,"SELECT * FROM `tbl_brandpage` where d_id='$title'");
$conrec=mysqli_num_rows($condata);
  ...
  if($conrec>0) { // if data exist update the data
    $_SESSION['error']="Data is already inserted";
      ...
      $query=mysqli_query($conn,"insert into `tbl_brandpage` SET `d_id`='$title',`image`='$aimage'");
      if($query)
        {
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Manage Brand Breadcrunbs</li>
			</ol>
			<!-- begin page-header -->
			<h1 class="page-header">Manage Brand Breadcrunbs</h1>
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage Brand Breadcrunbs</h4>
						</div>
						<!-- begin panel-body -->
		...
		<form role="form" method="POST"  enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group col-5">
                  <label for="heading">Homepage Brand Title</label>
              ...
              <!-- /.box-body -->
                    ...
                    <th width="1%" class="text-nowrap">Delete</th>
								...
								<tbody>
<?php $count=1; $condata=mysqli_query($conn,"SELECT * FROM `tbl_brandpage`");
...
$dp= $web['d_id'];
$cond = mysqli_query($conn,"SELECT * FROM `tbl_brand` where id='$dp'");
$web2=mysqli_fetch_array($cond);
?>

<tr class="odd gradeX">
<td width="1%" class="f-s-600 text-inverse"><?php echo $web['id'];?></td>
<td width="1%" class="with-img"><img src="../uploads/brand/<?php echo $web['image'];?>" class="img-rounded height-60" /></td>
...
<td><a href="delete/brand_page.php?bid=<?php echo $web['id'];?>" class='label label-sm label-danger' data-toggle="tooltip" title="Delete division" ><i class="fa fa-trash"></i> DELETE</a></td>

</tr>
                  <div class="modal fade" id="exampleModal<?=$count;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <form role="form" method="POST" action="edit-brandpage.php"  enctype="multipart/form-data">                  
