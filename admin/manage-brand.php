...
if(isset($_POST['Dectivate']) && $bb!='')
{
		foreach($bb as $act)
		{
		 mysqli_query($conn,"update tbl_brand set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"update tbl_brand set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"delete from tbl_brand where id='$act'");
		}
}
		
		$mqry="select * from tbl_brand order by id desc";
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage Brand</h4>
						</div>
						<!-- end panel-heading -->
                       <form name="myform" method="post" action=""> 
						...
						<div class="alert alert-secondary fade show">
							...
							<div class="btn-group btn-group-justified">
                              <a href="add-brand.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New Brand</a>
							...
							<table id="data-table-responsive" class="table table-striped table-bordered">
								<thead>
									<tr>
                                        ...
                                        <!--<th class="text-nowrap">Brand Category</th>-->
                                ...
                                <?php $count=1; $fetch=mysqli_query($conn,$mqry);
									 ...
									 $mtrc=mysqli_query($conn,"SELECT * FROM `tbl_brandcategory` WHERE id='".$web['category_id']."'");
									 $dtdc=mysqli_fetch_array($mtrc);
									?>

									<tr class="odd gradeX">
                                      <td width="1%" class="f-s-600 text-inverse"><?php echo $count;?></td>
                                      <td width="1%" class="with-img"><?php if($web['image']==0){ ?><img src="../uploads/no.png" class="img-rounded height-80" /><?php }else{ ?><img src="../uploads/brand/<?php echo $web['image'];?>" class="img-rounded height-80 bg-dark" /><?php } ?></td>
                                      ...
                                      <td><a href="edit-brand.php?bid=<?php echo $web['id'];?>" class='label label-sm label-primary' data-toggle="tooltip" title="Edit project" ><i class="fa fa-edit"></i> EDIT</a></td>
                                      <td><a href="delete/brand.php?bid=<?php echo $web['id'];?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" class='label label-sm label-danger' data-toggle="tooltip" title="Delete project" ><i class="fa fa-trash"></i> DELETE</a></td>
...
function updateId(id)
{
    ...
    xmlhttp.open("GET", "status/brand.php?id=" +id, true);
    xmlhttp.send();
}
</script>
