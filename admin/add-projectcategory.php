...
if(isset($_POST['submit']))
{
  ...
  $query=mysqli_query($conn,"INSERT INTO `tbl_projectcategory`(`name`, `sort`,`status`) VALUES ('$name','$sort','$status')");
	if($query==true)
	{
...
if(isset($_POST['update']))
{
  ...
  $sort=mysqli_real_escape_string($conn,$_POST['sort']);
  $status=mysqli_real_escape_string($conn,$_POST['status']);
  $query=mysqli_query($conn,"UPDATE `tbl_projectcategory` SET `name`='$name', `sort`='$sort', `status`='$status' WHERE `id`='$b'");
  if($query==true)
  {
	...
	<?php require("includes/left.php"); ?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Manage Portfolio Category </a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Portfolio Category </h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Add Portfolio Category</h4>
						</div>
						<!-- end panel-heading -->
                ...
                <div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">View Portfolio Category</h4>
						</div>
						<!-- end panel-heading -->
						<div class="panel-body">
						<!-- begin panel-body -->
						<table  class="table table-striped table-bordered">
								...
								<tbody>
                                <?php $trc=mysqli_query($conn,"SELECT * FROM `tbl_projectcategory` ORDER BY `id`"); 
						       ...
						       ?> 
									<tr class="odd gradeX">
                                        ...
                                        <div class="switcher">
                                         ...
                                         <td>
                                          <a href="#modal-editproject<?php echo $mrc['id'];?>" class="label label-sm label-primary" title="Edit" style="text-decoration: none;" data-toggle="modal"><i class="fa fa-edit"></i> Edit</a>
                             <div class="modal fade" id="modal-editproject<?php echo $mrc['id'];?>" aria-hidden="true" style="display: none;">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title">Edit Portfolio Category</h4>
                                        ...
                                        <td>
                                          <a href="delete/projectcategory.php?cid=<?php echo $mrc['id'];?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }"  class="label label-sm label-danger" title="Delete" style="text-decoration: none;"><i class="fa fa-trash"></i> Delete</a>
                                        </td>
									</tr>
								<?php } ?>
                                    <tfoot>
...
function updateId(id)
{
    ...
    xmlhttp.open("GET", "status/projectcategory.php?id=" +id, true);
    xmlhttp.send();
}
</script>
 <!--------------------------------------->  
