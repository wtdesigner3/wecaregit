...
$b = $_REQUEST['eid'];
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_brand_quality` where `id`='$b'");
...
if (isset($_POST['update'])) 
{
 ...
 $bimage= $brec['image'];
  ...
  $query = mysqli_query($conn, "UPDATE `tbl_brand_quality` SET `c_id`='$category',`image`='$bimage',`title`='$title',`alt`='$alt',`status`='$status',`sort`='$position' WHERE `id`='$b'");

  if ($query == true) 
  {
    $_SESSION['success'] = "Quality Updated Successfully";
    header("Refresh:2; url=manage-brand-quality.php");
  } 
  else 
  {
...
<body>
  ...
  <div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
      <li class="breadcrumb-item"><a href="javascript:;">Manage Quality</a></li>
      <li class="breadcrumb-item"><a href="javascript:;">Edit Quality</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Quality</h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
      <!-- begin col-10 -->
      <div class="col-lg-12">
        ...
        <div class="panel panel-inverse">
          ...
          <div class="panel-heading">
            ...
            <h4 class="panel-title">Edit Quality</h4>
          </div>
          <!-- end panel-heading -->
            ...
            <form role="form" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img style="width:20%;" src="../uploads/brand/<?= $brec['image']; ?>">
                </div>
