...
$condata=mysqli_query($conn,"SELECT * FROM `tbl_tc`");
...
if(isset($_POST['update']))
{
 ...
 $aimage = $conrec['image'];
        ...
        $query=mysqli_query($conn,"UPDATE `tbl_tc` SET `abt_title`='$title',`image`='$aimage',`abt_titletag`='$metatag',`abt_keyword`='$keyword',`abt_metadesc`='$metadesc',`abt_details`='$detail', `head_detail` = '$head_detail'");
 
      
        if($query)
      {
			$_SESSION['success']="Terms & Condition Updated Successfull";
            header("refresh: 3;");
      }
        else
      {
	...
	<?php require("includes/left.php"); ?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				<li class="breadcrumb-item"><a href="javascript:;">Terms & Conditions Management</a></li>
				<li class="breadcrumb-item active">Edit Terms & Conditions</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Manage Terms & Conditions <small>...</small></h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
