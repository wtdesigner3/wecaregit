...
if (isset($_POST['submit'])) {
  ...
  //====end===//
    ...
    $query = mysqli_query($conn, "INSERT INTO `tbl_brand_services`(`c_id`, `image`,`alt` ,`image2`,`alt2` ,`title`, `status`, `sort`) VALUES ('$category','$bimage','$alt','$bimage2','$alt2','$title','$status','$position')");
    if ($query == true) {
        $_SESSION['success'] = "Brand Services inserted successfully";
...
<body>
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">Add Brand Services</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Manage Brand Services <small>.</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-10 -->
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Brand Services</h4>
                    </div>
                    <!-- end panel-heading -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="alt2" class="form-control" placeholder="Enter alt2">
                                </div>
                                <div class="form-group">
