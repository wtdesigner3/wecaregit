...
if (isset($_POST['submit'])) {
 ...
 $alt = mysqli_real_escape_string($conn, $_POST['alt']);
    ...
    $query = mysqli_query($conn, "INSERT INTO `tbl_why_us`( `brand_id`,`image`,`alt`,`image2`,`alt2`,`title`,`subtitle`, `status`, `sort`) VALUES ('$category','$bimage','$alt','$bimage2','$alt2','$title','$subtitle','$status','$position')");
    if ($query == true) {
...
<body>
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">Add Why Us</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Manage Why Us<small>.</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-10 -->
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Why Us</h4>
                    </div>
                    <!-- end panel-heading -->
