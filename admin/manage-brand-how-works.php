...
if(isset($_POST['Deactivate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"update tbl_brand_works set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"update tbl_brand_works set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"delete from tbl_brand_works where id='$act'");
		}
}
		
		$mqry="select * from tbl_brand_works ";
	...
	<?php require("includes/left.php"); ?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">How It Works Management</a></li>
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage How It Works</h4>
						</div>
						<!-- end panel-heading -->
                       <form name="myform" method="post" action=""> 
						...
						<div class="alert alert-secondary fade show">
							...
							<div class="btn-group btn-group-justified">
                              <a href="add-brand-how-works.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New How It Works</a>
							...
							<table id="data-table-responsive" class="table table-striped table-bordered">
			                    ...
			                    ?>
									<tr class="odd gradeX">
										...
										<td>
                                            <a href="edit-brand-how-works.php?eid=<?php echo $web['id'];?>" class='label label-sm label-primary' title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                         </td>
                                         <td>
                                             <a href="delete/brand-how-works.php?cid=<?php echo $web['id'];?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" class='label label-sm label-danger'>
...
function updateId(id)
{
    ...
    xmlhttp.open("GET", "status/brand-how-works.php?id=" +id, true);
    xmlhttp.send();
}
</script>
 <!----------------Check Box-----------------------> 
