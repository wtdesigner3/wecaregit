...
$b = $_REQUEST['eid'];
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_brand_benifits` where `id`='$b'");
...
$alt2 = mysqli_real_escape_string($conn, $_POST['alt2']);
 ...
 $bimage2= $brec['image2'];
  ...
  $query = mysqli_query($conn, "UPDATE `tbl_brand_benifits` SET `c_id`='$category',`image`='$bimage',`alt`='$alt',`image2`='$bimage2',`alt2`='$alt2',`title`='$title',`status`='$status',`sort`='$position' WHERE `id`='$b'");

  if ($query == true) 
  {
    $_SESSION['success'] = "Updated Successfully";
    header("Refresh:2; url=manage-brand-benifits.php");
  } 
  else 
  {
...
<body>
  ...
  <div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
      <li class="breadcrumb-item"><a href="javascript:;">Manage Proven Benefits</a></li>
      <li class="breadcrumb-item"><a href="javascript:;">Edit Proven Benefits</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Proven Benefits</h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
      <!-- begin col-10 -->
      <div class="col-lg-12">
        ...
        <div class="panel panel-inverse">
          ...
          <div class="panel-heading">
            ...
            <h4 class="panel-title">Edit Proven Benefits</h4>
          </div>
          <!-- end panel-heading -->
            ...
            <form role="form" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img style="width:20%; background:gray;" src="../uploads/brand/<?= $brec['image']; ?>">
                </div>
                ...
                <div class="form-group">
                  <label for="exampleInputFile">File Input2</label>
                  <input type="file" name="bimage2" class="form-control" id="exampleInputFile">
                  <p class="help-block">Image dimension must be 764 X 384 & must be jpg format</p>
                  <img style="width:20%; background:gray;" src="../uploads/brand/<?= $brec['image2']; ?>">
                </div>
