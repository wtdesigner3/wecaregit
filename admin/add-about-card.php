...
if (isset($_POST['submit'])) {
    ...
    if ($bimages != '') {
        ...
        $query = mysqli_query($conn, "INSERT INTO `tbl_about_card`(`title`,`text`,`image`, `sort`, `status`) 
    VALUES ('$title','$content','$bimage','$position','$status')");
    } else {
        $_SESSION['error'] = "Image Required";
    }
    if ($query == true) {
        $_SESSION['success'] = "About card inserted successfully";
...
<body>
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">Add About Card</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add About Card</h4>
                    </div>
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        <form role="form" method="POST" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="content1">Card Title Content</label>
                                    <input type="text" name="text" class="form-control" id="content1"
                                        placeholder="Enter Card Title Content">
                                </div>
