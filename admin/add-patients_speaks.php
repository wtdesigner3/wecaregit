...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO `tbl_project_videos`(`c_id`, `url`, `sort`, `status`) VALUES ('$category','$url','$position','$status')");
    if ($query == true) {
        $_SESSION['success'] = "Patients Speaks inserted successfully";
...
<body>
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">Add Project Video</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Manage Patients Speaks <small>.</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-10 -->
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Patients Speaks</h4>
                    </div>
                    <!-- end panel-heading -->
                        ...
                        <form role="form" method="POST" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="url" class="form-control" id="banner" placeholder="Enter Project Url">
                                </div>
