...
$b = $_REQUEST['eid'];
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_brand_services` where `id`='$b'");
...
if (isset($_POST['update'])) 
{
 ...
 $bimage= $brec['image'];
  ...
  $query = mysqli_query($conn, "UPDATE `tbl_brand_services` SET `c_id`='$category',`image`='$bimage',`image2`='$bimage2',`title`='$title',`status`='$status',`sort`='$position',`alt`='$alt',`alt2`='$alt2' WHERE `id`='$b'");

  if ($query == true) 
  {
    $_SESSION['success'] = "Brand Services Updated Successfully";
    header("Refresh:2; url=manage-brand-services.php");
  } 
  else 
  {
...
<body>
  ...
  <div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
      <li class="breadcrumb-item"><a href="javascript:;">Manage Brand Services</a></li>
      <li class="breadcrumb-item"><a href="javascript:;">Edit Brand Services</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Brand Services</h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
      <!-- begin col-10 -->
      <div class="col-lg-12">
        ...
        <div class="panel panel-inverse">
          ...
          <div class="panel-heading">
            ...
            <h4 class="panel-title">Edit Brand Services</h4>
          </div>
          <!-- end panel-heading -->
