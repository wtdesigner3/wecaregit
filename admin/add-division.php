...
{  
  ...
  $alt2 = mysqli_real_escape_string($conn,$_POST['alt2']);
	...
	$query=mysqli_query($conn,"INSERT INTO `tbl_division`(`title`,`alt1`,`alt2`,`cname`, `loc`, `exp`, `work`, `emp`, `sal`, `url`, `image`, `imghover`, `shortdes`, `des`, `metatag`, `keyword`, `metadesc`, `sort`, `status`, `date`) VALUES ('$title','$alt1','$alt2','$cname','$loc','$exp','$work','$emp','$sal','0','$bimage','$cimage','$desc','$des','$metatag','$keyword','$metadesc','$position','$status',' $phpdate')");
		if($query==true)
		{
		...
		header("refresh:3;url=add-division.php");	
		} 
   }
?>
<!DOCTYPE html>
			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Add Job</h4>
						</div>
						<!-- end panel-heading -->
              ...
              <div class="box-body">
                 ...
                 <div class="form-group">
                  <label for="one">Job Title</label>
                  <input type="text"  name="title" class="form-control" id="one" placeholder="Enter Title">
                </div>
               
                 <!-- <div class="form-group">
                  <label for="two">Division Url</label><code>Same as Service name & avoid Special Characters</code>
                  <input type="hidden"  name="pgurl"  placeholder="division Url's" class="form-control" id="two">
                  <code class="help-block">Your url : http://example.com/Service-detail/</code>
                </div> -->
                
                  <div class="form-group">
                  <label for="dd">Company Name</label>
                  <input type="text"  name="cname" class="form-control" id="dd" placeholder="Enter Name">
                </div>

				<div class="form-group">
                  <label for="dd">Job Location</label>
                  <input type="text"  name="loc" class="form-control" id="dd" placeholder="Enter Location">
                </div>

				<div class="form-group">
                  <label for="dd">Job Experience</label>
                  <input type="text"  name="exp" class="form-control" id="dd" placeholder="Enter Experience">
                </div>

				<div class="form-group">
                  <label for="dd">Job Work Level</label>
                  <input type="text"  name="work" class="form-control" id="dd" placeholder="Enter Work Level">
                </div>

				<div class="form-group">
                  <label for="dd">Job Type</label>
                  <input type="text"  name="emp" class="form-control" id="dd" placeholder="Enter Job Type">
                </div>

				<div class="form-group">
                  <label for="dd">Offer Salary</label>
                  <input type="text"  name="sal" class="form-control" id="dd" placeholder="Enter Offer Salary">
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">Career Background Image</label>
                ...
                <div class="form-group">
                  ...
                  <input type="text"  name="alt1" class="form-control" id="dd" placeholder="Enter Alt">
                </div>
                ...
                <div class="form-group">
                  <label for="dd">Alt</label>
                  <input type="text"  name="alt2" class="form-control" id="dd" placeholder="Enter Alt">
                </div>

				<div class="form-group">
                  <label for="dd">Short Description</label>
                  <input type="text"  name="desc" class="form-control" id="dd" placeholder="Enter Text">
                </div>
