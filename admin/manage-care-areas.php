...
if(isset($_POST['Deactivate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"update tbl_care_areas set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"update tbl_care_areas set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"delete from tbl_care_areas where id='$act'");
		}
}
		
		$mqry="select * from tbl_care_areas ";
	...
	<?php require("includes/left.php"); ?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Manage Care Areas</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Manage Care Areas </h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage Care Areas</h4>
						</div>
						<!-- end panel-heading -->
                       <form name="myform" method="post" action=""> 
						...
						<div class="alert alert-secondary fade show">
							...
							<div class="btn-group btn-group-justified">
                              <a href="add-care-areas.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New Care Areas</a>
							...
							<table id="data-table-responsive" class="table table-striped table-bordered">
			                    ...
			                    ?>
									<tr class="odd gradeX">
                                        ...
                                        <td  width="20%"><?= $web["title"]; ?></td>
                                        <td  width="40%"><?= $web["subtitle"]; ?></td>
										...
										<td>
                                            <a href="edit-care-areas.php?eid=<?php echo $web['id'];?>" class='label label-sm label-primary' title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                         </td>
                                         <td>
                                             <a href="delete/care-areas.php?cid=<?php echo $web['id'];?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" class='label label-sm label-danger'>
...
function updateId(id)
{
    ...
    xmlhttp.open("GET", "status/care-areas.php?id=" +id, true);
    xmlhttp.send();
}
</script>
 <!----------------Check Box-----------------------> 
