...
if (isset($_POST['submit'])) {
  ...
  //====end===//
    ...
    $query = mysqli_query($conn, "INSERT INTO `tbl_brand_benifits`(`c_id`, `image`, `image2`,`alt`, `alt2`, `title`, `status`, `sort`) VALUES ('$category','$bimage', '$bimage2','$alt', '$bimage2','$title','$status','$position')");
    if ($query == true) {
...
<body>
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">Add Proven Benefits</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Manage Proven Benefits <small>.</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-10 -->
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Proven Benefits</h4>
                    </div>
                    <!-- end panel-heading -->
