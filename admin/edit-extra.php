...
$b = $_REQUEST['eid'];
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_extra` where `id`='$b'");
...
$query = mysqli_query($conn, "UPDATE `tbl_extra` SET `title_id`='$heading',`brand_id`='$category',`title`='$title',`alt`='$alt',`alt2`='$alt2',`image`='$bimage',`image2`='$bimage2',`subtitle`='$subtitle',`status`='$status',`sort`='$position' WHERE `id`='$b'");

  if ($query == true) 
  {
    $_SESSION['success'] = "Updated Successfully";
    header("Refresh:2; url=manage-extra.php");
  } 
  else 
  {
...
<body>
  ...
  <div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
      <li class="breadcrumb-item"><a href="javascript:;">Manage Extra</a></li>
      <li class="breadcrumb-item"><a href="javascript:;">Edit Extra</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-inverse">
          ...
          <div class="panel-heading">
            ...
            <h4 class="panel-title">Edit Extra</h4>
          </div>
          <!-- end panel-heading -->
          ...
          <div class="panel-body">
            <form role="form" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                  <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="heading" class="form-control" required>
                            ...
                            <?php
                            $cdata = mysqli_query($conn, "SELECT * FROM `tbl_extra_content` WHERE  `status`='1' ");
                            while ($crec = mysqli_fetch_array($cdata)) 
                            {
                              if($brec["title_id"]==$crec["id"])
                              {
                                ?>
                                  <option value="<?= $crec['id']; ?>" selected><?= $crec['title']; ?></option>
                              <?php
                              }
                              else
                              {
               ...
               <div class="col-lg-6">
                  <div class="form-group">
                  <label for="exampleInputFile">File Input (White)</label>
               ...
               <div class="col-lg-6">
                <div class="form-group">
                  <label for="exampleInputFile">File Input 2 (Dark)</label>
