...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO `tbl_hmbanner_extra` (`title`,`sort`, `status`,`image`,`alt`,`content`) VALUES ('$title', '$sort', '$status','$bimage','$alt','$content')");
    if ($query == true) {
...
<body>
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">Add Why Us Extra</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header"><a href="javascript:;" onClick="javascript:history.go(-1)"
                class="btn btn-l btn-icon btn-circle btn-primary" data-click="panel-remove"><i
                    class="fa fa-arrow-left"></i></a> Manage Why Us Extra</h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-10 -->
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Why Us Extra</h4>
                    </div>
                    <!-- end panel-heading -->
