...
$mqry="select * from tbl_banner order by bnr_id desc";
?>
<!DOCTYPE html>
<html lang="en">
							...
							<table id="data-table-responsive" class="table table-striped table-bordered">
			                    ...
			                    ?>
									<tr class="odd gradeX">
										...
										<td width="1%" class="with-img"><?php if($web['bnr_image']==0){ ?><img src="../uploads/no.png" class="img-rounded height-50" /><?php }else{ ?><img src="../uploads/banner/<?php echo $web['bnr_image'];?>" class="img-rounded height-50" /><?php } ?></td>
										...
										<td>
                                          <a href="edit-banner.php?bid=<?php echo $web['bnr_id'];?>" class='label label-sm label-primary' data-toggle="tooltip" title="Edit Banner"><i class="fa fa-edit"></i> Edit</a>
                                        </td>
                                        <td>
                                          <a href="delete/banner.php?bid=<?php echo $web['bnr_id'];?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" data-toggle="tooltip" title="Delete Banner" class='label label-sm label-danger'><i class="fa fa-trash"></i> Delete</a>
                                         </td>
                                        <td width="1%">
