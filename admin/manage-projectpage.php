...
$condata=mysqli_query($conn,"SELECT * FROM `tbl_projectpage`");
...
// image one
 if(!empty($_FILES["aimage"]["name"])) { 
  ...
  move_uploaded_file($_FILES['aimage']['tmp_name'],"../uploads/project/".$aimage);
  }else{
 $aimage = $conrec['image'];
}

  $query=mysqli_query($conn,"UPDATE `tbl_projectpage` SET `title`='$title',`image`='$aimage'");
if($query)
  {
		...
		<form role="form" method="POST"  enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="heading">Homepage Portfolio Title</label>
