...
$b = $_REQUEST['eid'];
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_brand_works` where `id`='$b'");
...
if (isset($_POST['update'])) 
{
  ...
  $query = mysqli_query($conn, "UPDATE `tbl_brand_works` SET `brand_id`='$category',`title`='$title',`subtitle`='$subtitle',`status`='$status',`sort`='$position' WHERE `id`='$b'");
...
<body>
  ...
  <div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
      <li class="breadcrumb-item"><a href="javascript:;">Manage How It Works</a></li>
      <li class="breadcrumb-item"><a href="javascript:;">Edit How It Works</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit How It Works</h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
      <!-- begin col-10 -->
      <div class="col-lg-12">
        ...
        <div class="panel panel-inverse">
          ...
          <div class="panel-heading">
            ...
            <h4 class="panel-title">Edit How It Works</h4>
          </div>
          <!-- end panel-heading -->
