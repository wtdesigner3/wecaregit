...
if (isset($_POST['submit'])) {
  ...
  //====end===//
    ...
    $query = mysqli_query($conn, "INSERT INTO `tbl_brand_quality`(`c_id`, `image`,`alt`, `title`, `status`, `sort`) VALUES ('$category','$bimage','$alt','$title','$status','$position')");
    if ($query == true) {
        $_SESSION['success'] = "Quality inserted successfully";
...
<body>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Manage Quality <small>.</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-10 -->
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Quality</h4>
                    </div>
                    <!-- end panel-heading -->
