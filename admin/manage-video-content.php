...
$condata=mysqli_query($conn,"SELECT * FROM `tbl_video_content`");
...
$subtitle = mysqli_real_escape_string($conn,$_POST['subtitle']);
  ...
  $query=mysqli_query($conn,"UPDATE `tbl_video_content` SET `title`='$title',`subtitle`='$subtitle'");
    if($query)
  {
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Manage Video  Content</li>
			</ol>
			<!-- begin page-header -->
			<h1 class="page-header">Manage Video  Content</h1>
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage Video  Content</h4>
						</div>
						<!-- begin panel-body -->
