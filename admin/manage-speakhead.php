...
$condata=mysqli_query($conn,"SELECT * FROM `tbl_speakhead`");
...
$subtitle = mysqli_real_escape_string($conn,$_POST['subtitle']);
  ...
  $query=mysqli_query($conn,"UPDATE `tbl_speakhead` SET `title`='$title',`subtitle`='$subtitle',`image`='0'");
    if($query)
  {
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Manage Patients Speaks  Content</li>
			</ol>
			<!-- begin page-header -->
			<h1 class="page-header">Manage Patients Speaks  Content</h1>
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage Patients Speaks  Content</h4>
						</div>
						<!-- begin panel-body -->
