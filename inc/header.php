  ...
  <div class="top-bar-inner">
    ...
    <div class="top-bar-ticker">
      <div class="ticker-track">
        <span class="ticker-item"><span class="ticker-dot"></span>✦ Now accepting new patients — Book your smile consultation today!</span>
        <span class="ticker-item"><span class="ticker-dot"></span>Emergency dental care available — Call us anytime</span>
        <span class="ticker-item"><span class="ticker-dot"></span>Modern dentistry with a gentle touch — Experience the difference</span>
        <span class="ticker-item"><span class="ticker-dot"></span>Trusted by thousands of happy patients across the region</span>
    ...
    <div class="top-bar-contacts">
      <a class="contact-pill pill-address" href="https://maps.google.com/?q=YOUR+CLINIC+ADDRESS" target="_blank" rel="noopener">
      ...
      <a class="contact-pill pill-phone" href="tel:<?= $coninfo['con_phone1']; ?>">
        <svg class="pill-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.27h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.83a16 16 0 0 0 5.58 5.58l1.5-1.5a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.73 15"/>
        </svg>
    ...
    <div class="header-inner">
        ...
        <a href="<?= BASE_URL; ?>" class="header-logo">
            <?php if (!empty($proinfo['pro_logo'])): ?>
                <img src="<?= BASE_URL; ?>uploads/<?= $proinfo['pro_logo']; ?>" alt="<?= $proinfo['pro_title']; ?>" class="logo-img">
            <?php else: ?>
                <div class="logo-fallback-mark">
                    <svg viewBox="0 0 24 24"><path d="M12 2C8.5 2 5 5.5 5 9c0 2.5 1.2 4.5 3 6l1.5 7h5L16 15c1.8-1.5 3-3.5 3-6 0-3.5-3.5-7-7-7z"/></svg>
                </div>
        ...
        <!-- Book CTA -->
        <a href="<?= BASE_URL; ?>contact" class="header-cta  d-none d-md-block">
...
<div class="mobile-drawer" id="mobileDrawer">
    ...
    <div class="drawer-panel">
        ...
        <div class="drawer-top">
            <?php if (!empty($proinfo['pro_logo'])): ?>
            <img src="<?= BASE_URL; ?>uploads/<?= $proinfo['pro_logo']; ?>" alt="<?= $proinfo['pro_title']; ?>" class="drawer-logo">
            <?php else: ?>
            <span style="font-family:'Cormorant Garamond',serif; font-size:18px; font-weight:600; color:var(--charcoal);"><?= $proinfo['pro_title'] ?? 'DentalCare'; ?></span>
            <?php endif; ?>
        ...
        <div class="drawer-footer">
            <a href="<?= BASE_URL; ?>contact" class="drawer-cta">Book Appointment</a>
            <?php if (!empty($coninfo['con_phone1'])): ?>
