...
if ($result && $result->success) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!empty($errors)) {
            ...
            echo "<script>alert('" . $errorText . "'); window.location='" . BASE_URL . "';</script>";
            exit;
        }             

        if (!empty($phone) && !empty($fname)) {

            $to      = 'wtdeveloperpankaj@gmail.com';
            // $to      = 'info@wecare.com';
            $subject = 'WeCare Dental Footer Query From ' . $name;
...
<body style="margin:0;padding:0;font-family:Arial,sans-serif;background-color:#f8f9fa;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
        ...
        <tr>
            ...
            echo '<script>alert("Please fill up all the required fields (Phone & First Name)!");</script>';
